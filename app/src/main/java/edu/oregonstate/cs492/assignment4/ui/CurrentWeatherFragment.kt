...
class CurrentWeatherFragment : Fragment(R.layout.fragment_current_weather) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.weather.observe(viewLifecycleOwner) { weather ->
            if (weather != null) {
                ...
                val city = ForecastCity(weather.name ?: "No City Name", lat?.toDouble() ?: 44.569722, lon?.toDouble() ?: -123.278333, weather.tzOffsetSec)
    ...
    override fun onResume() {
        ...
        viewModel.loadCurrentWeather(lat, lon, units, getString(R.string.openweather_api_key))
    }
    ...
    private fun bind(weather: ForecastPeriod) {
        ...
        val cloudsIcon = AppCompatResources.getDrawable(requireContext(), R.drawable.ic_action_cloud_24)
